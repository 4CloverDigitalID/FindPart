  ...
  return (
    <div className="flex h-screen bg-gray-50 text-gray-900 overflow-hidden font-sans">
      ...
      <aside
              ...
              className="flex flex-col bg-white border-r border-gray-100 shrink-0 overflow-hidden z-10 shadow-sm"
            >
              {/* Logo */}
              <div className="h-16 flex items-center px-5 gap-3 border-b border-gray-100">
                {sidebarOpen && (
                  <span style={{ fontFamily: "poppins" }} className="font-semibold text-lg text-gray-900 whitespace-nowrap overflow-hidden">
                    FindPart
                  </span>
